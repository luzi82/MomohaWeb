...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('MomohaFeed_subscription', 'title',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=1024, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Subscription.title'
        db.delete_column('MomohaFeed_subscription', 'title')
