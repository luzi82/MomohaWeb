...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Item', fields ['published']
        db.create_index('MomohaFeed_item', ['published'])


    def backwards(self, orm):
        # Removing index on 'Item', fields ['published']
        db.delete_index('MomohaFeed_item', ['published'])
