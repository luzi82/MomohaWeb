...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.first_poll'
        db.add_column('MomohaFeed_item', 'first_poll',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Item.first_poll'
        db.delete_column('MomohaFeed_item', 'first_poll')
    ...
    models = {
        ...
        'MomohaFeed.item': {
            ...
            'first_poll': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
